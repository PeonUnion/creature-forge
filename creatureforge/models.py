# =========================================================================
# CreatureForge — 数据驱动角色素材管线 · Python 类型声明
# =========================================================================
# 本文档使用 typing.TypedDict 声明项目核心数据结构。
# 对应前端类型声明：creatureforge/interfaces.ts（同名结构，双端一致）。
...
class SpeciesSkeleton(TypedDict):
    ...
    schema: 格式版本 "creatureforge_species_v1"
    title: 显示名称
    description: 描述文本
...
class Preset(TypedDict):
    ...
    schema: 格式版本 "creatureforge_preset_v1"
...
class Motion(TypedDict):
    ...
    schema: 格式版本 "creatureforge_motion_v1"
