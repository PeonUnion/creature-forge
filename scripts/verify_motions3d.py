...
from creatureforge.skeleton3d import build_skeleton_3d, pose_3d, load_species
from creatureforge.config import DEFAULT_DATA_DIR
...
def verify(species_id: str, motion3d: dict, params: dict | None = None,
    ...
    if coord:
        from creatureforge.motion import _build_signals, _resolve_params
